...
return {"folke/noice.nvim", dependencies = {"MunifTanjim/nui.nvim", "rcarriga/nvim-notify", "nvim-telescope/telescope.nvim"}, keys = {{"<leader>ns", "<cmd>Noice telescope<cr>", desc = "Search message log"}, {"<leader>nv", "<cmd>Noice<cr>", desc = "View message log"}}, config = _1_, lazy = false}